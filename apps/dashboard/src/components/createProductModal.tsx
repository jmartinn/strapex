...
import { Dialog, Button, Flex, Text, TextField, RadioGroup, Select, RadioCards, Blockquote } from "@radix-ui/themes";
...
const CreateProductModal = ({ addresses }: CreateProductModalProps) => {
    ...
    return (
        <Dialog.Root open={isOpen}>
            <Dialog.Trigger className="bg-main text-white px-4 py-2 rounded-md">
                <Button onClick={() => setIsOpen(true)} className="bg-main text-white">Create a product</Button>
            </Dialog.Trigger>
            <Dialog.Content>
