...
export default function CheckoutPage(props: CheckoutPageProps) {
  ...
  const [_connection, setConnection] = useState<StarknetWindowObject | null>(
    null,
  );
  ...
  const payWithStarknet = async () => {
    ...
    let _amount = sessionData.totalPrice;
  ...
  function calculateQrContent() {
    ...
    let amount: Uint256 = uint256.bnToUint256(
  ...
  return (
    <div className="flex h-screen flex-col md:flex-row">
      <div className="flex w-full flex-col bg-neutral-800 p-8 text-neutral-100 md:w-1/2">
