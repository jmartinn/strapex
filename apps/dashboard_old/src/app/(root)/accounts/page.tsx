...
import BizWalletCard from "@/components/biz-wallet-card";
...
import { BizWalletWithBalance, Item, Product, SessionData } from "@/types";
...
export default function Accounts() {
  ...
  const handleDeleteProduct = async (productId: ObjectId | undefined) => {
    ...
    try {
      ...
      const _result = await collection?.deleteOne({ _id: productId });
